...
void setup()   /****** SETUP: RUNS ONCE ******/
{
  ...
  pinMode(SIG_LED,OUTPUT);//D3 will be used as a signal led for success transmission.
...
void loop()   /****** LOOP: RUNS CONSTANTLY ******/
{
  ...
  {
    if((myData.Xposition<400 || myData.Xposition>600) || (myData.Yposition<400 || myData.Yposition>600))
